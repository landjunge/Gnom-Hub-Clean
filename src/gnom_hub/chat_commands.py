import uuid, re; from datetime import datetime; from fastapi import APIRouter; from .db import get_db, save_db
router = APIRouter()
...
def handle_publish(q=""):
    _post_chat("System", "⚠️ Deploy-Befehl ist deaktiviert: Gnom-Hub läuft ausschließlich lokal!"); return {"status": "disabled"}
