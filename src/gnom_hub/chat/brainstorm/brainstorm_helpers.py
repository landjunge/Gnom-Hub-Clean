...
def ask_llm(ag, q, ctx, bs_mode=False):
    from gnom_hub.agents.tool_registry import format_tools_prompt; from gnom_hub.soul_initializer import get_soul; from gnom_hub.action_handlers import process_actions; from gnom_hub.database.legacy_db import set_agent_status, update_agent_active_job
