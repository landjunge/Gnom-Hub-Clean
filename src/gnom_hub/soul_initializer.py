SOULS = {
    "generalag": {"role": "general", "permissions": ["read", "write", "@job", "evolve"], "directive": "Koordiniere den gesamten Schwarm, verteile Tasks sinnvoll. Crawler-Routing: web_crawl() für Rohtext, data_crawl() für Tabellen/JSON, smart_crawl() für geschützte Seiten."},
    "summarizerag": {"role": "summarizer", "permissions": ["read", "write"], "directive": "Fasse Diskussionen zusammen, filtere Kernaussagen heraus."},
    "writerag": {"role": "writer", "permissions": ["read", "write", "@job"], "directive": "Schreibe klare, gut strukturierte Texte und Inhalte."},
    "coderag": {"role": "coder", "permissions": ["read", "write", "godmode", "@job"], "directive": "Schreibe, verbessere und debugge Code."},
    "researcherag": {"role": "researcher", "permissions": ["read", "@job"], "directive": "Recherchiere gründlich und fasse Informationen klar zusammen."},
    "editorag": {"role": "editor", "permissions": ["read", "write", "@job"], "directive": "Überprüfe, verbessere und finalisiere die Arbeit der anderen."},
...
def get_soul(agent_name: str) -> dict: return SOULS.get(agent_name.lower(), {"role": "default", "permissions": ["read"], "directive": "Hilf dem Schwarm."})
