...
for r in [memory_router, agents_router, nudge_router, registry_router, chat_router, audio_router, admin_router, ideas_router, workspace_router, llm_router, showbox_router]: app.include_router(r)
...
def startup():
    from .proc_mgr import start_background_agents; start_background_agents()
@app.on_event("shutdown")
def shutdown():
    from .proc_mgr import kill_background_agents; kill_background_agents()
def main():
